...
type ResponseParamsObject struct {
...
func ErrorJsonStandardResponse(params *ResponseParamsObject) {
...
func SuccessJsonStandardResponse(params *ResponseParamsObject) {
	if params.StatusCode == 0 {
